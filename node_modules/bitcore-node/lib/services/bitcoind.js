...
//Bitcoin.DEFAULT_ZMQ_SUBSCRIBE_PROGRESS = 0.001;
...
Bitcoin.prototype._loadSpawnConfiguration = function(node) {
  ...
  var configPath = path.resolve(spawnOptions.datadir, './bitcoincandy.conf');

  log.info('Using bitcoin candy config file:', configPath);
